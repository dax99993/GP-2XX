        ...
        <BoundBox>
            <VStack space="lg">
                ...
                <ButtonGroup space="md" flexDirection="row" style={{alignItems: 'center', justifyContent: 'space-around'}}>
                    ...
                    <Button size="sm" action="primary" variant={selectedCtrl == 1 ? "solid" : "outline"} onPress={() => changeSelectedCtrl(1)}>
                        <ButtonText>CTRL 2</ButtonText>
                    </Button>
                    <Button size="sm" action="primary" variant={selectedCtrl == 2 ? "solid" : "outline"} onPress={() => changeSelectedCtrl(2)}>
                ...
                <ButtonGroup space="sm" flexDirection="row" style={{alignItems: 'center', justifyContent: 'space-around'}}>
                    ...
                    <Button size="sm" action="primary" variant={selectedCtrl == 5 ? "solid" : "outline"} onPress={() => changeSelectedCtrl(5)}>
                        <ButtonText>CTRL 6</ButtonText>
                    </Button>
                    <Button size="sm" action="primary" variant={selectedCtrl == 6 ? "solid" : "outline"} onPress={() => changeSelectedCtrl(6)}>
                        <ButtonText>CTRL 7</ButtonText>
                    </Button>
                    <Button size="sm" action="primary" variant={selectedCtrl == 7 ? "solid" : "outline"} onPress={() => changeSelectedCtrl(7)}>
